...
export default function DhruvHeader({ content, type, is_active, position, variant }) {
  const [isMobileMenuOpen, setIsMobileMenuOpen] = useState(false);

  if (!is_active) return null;

  return (
    <header className="bg-white shadow-md" data-type={type} data-position={position} data-variant={variant}>
      {/* Top Bar */}
      <div className="bg-gray-900 text-white py-2">
        <div className="container mx-auto px-4 flex justify-between items-center">
          <div className="flex space-x-4">
            ...
            <a href="mailto:info@example.com" className="text-sm hover:text-gray-300">
              <span className="flex items-center">
                <svg className="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      <nav className="container mx-auto px-4 py-4">
        <div className="flex justify-between items-center">
          ...
          <Link href="/" className="flex items-center">
            ...
            <span className="text-xl font-bold text-gray-900">{content.title || "Your Logo"}</span>
          </Link>
